...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView newsContributor;
        ...
        public ViewHolder(Context context, View itemView){
            ...
            newsContributor = (TextView) itemView.findViewById(R.id.author);
    ...
    public void onBindViewHolder(NewsAdapter.ViewHolder viewHolder, int position) {
        ...
        TextView newsContributorTextView = viewHolder.newsContributor;
        ...
        newsContributorTextView.setText(newsItem.getContributor());
